# -*- coding: utf-8 -*-
#
# lim documentation build configuration file, created by
...
# Example configuration for intersphinx: refer to the Python standard library.nature
